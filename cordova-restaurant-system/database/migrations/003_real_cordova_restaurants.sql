...
-- ============================================================================
-- 5–11. Name-confirmed businesses — [Name confirmed, location approximate]
...
-- Solea Mactan Restaurant: no verified hours found — default to a
...
WHERE r.id IN ('2d9bdb3c-5cb3-4e1b-b6a6-82137087d563')
ON CONFLICT DO NOTHING;
